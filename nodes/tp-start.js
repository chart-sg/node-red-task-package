 ...
 *  Entry point for task package flows
 ...
 */
function handleStartEvent(payload) {
    ...
    try {
        ...
        // Generate tpc_id (task package created ID)
        const tpc_id = payload.tpc_id || uuidv4()
        
        // Store task context in node instance (not flow) for parallel support
        ...
        // TODO: Update database status to 'underway'
